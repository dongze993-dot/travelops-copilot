...
一个可运行的旅行计划项目：输入中国城市、县城或景区名称，生成一张按天阅读的游玩计划表，并给出游玩预算参考。
...
3. 按早、中、下午、晚整理每天的景点、餐饮和慢游安排；
4. 展示景区与体验、餐饮、市内短途出行、小额伴手礼和机动预留的粗略预算；
5. 在计划末尾保留本次使用的资料链接，方便出发前自行确认。

预算**不含往返交通与住宿**，也不是实时票价、菜单价格或预订报价。票价、营业时间、预约要求会变化，出行前应打开资料来源或官方渠道确认。若公开资料不足，页面会如实提示，而不会编造景点、餐厅或价格。
...
| Netlify 公开页面 | 静态前端 + Node.js Netlify Functions + 免费公开资料查询 | 面向游客的按日计划、来源链接和粗略游玩预算 |
